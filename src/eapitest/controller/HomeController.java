...
//    
//    @FXML
//    void launchAccountT(ActionEvent event) throws IOException {
    ...
    void keyPressed(KeyEvent e) throws IOException
    {
        ...
        { 
            case D: 
            {
                ...
                Stage disputeWindow = (Stage) ((Node) e.getSource()).getScene().getWindow();
                disputeWindow.setScene(disputeUI);
                //dController.setActiveUser(activeUser);
                dController.setPreviousScene(((Node) e.getSource()).getScene());
                disputeWindow.show();
            }
            case A: 
            {
                ...
                accountWindow.setFullScreenExitKeyCombination(KeyCombination.keyCombination("Ctrl+A"));
                accountWindow.setScene(accountUI);
                //aController.setActiveUser(activeUser);
                aController.setPreviousScene(((Node) e.getSource()).getScene());
                accountWindow.show();
            }
            case L:
            {
                ...
                Stage loanAppWindow = (Stage) ((Node) e.getSource()).getScene().getWindow();
                loanAppWindow.setScene(loanAppUI);
                //laController.setActiveUser(activeUser);
                laController.setPreviousScene(((Node) e.getSource()).getScene());
                loanAppWindow.show();
            }
            case S:
            {
                FXMLLoader loanStatusLoader = new FXMLLoader(getClass().getResource("/eapitest/view/loanStatusView.fxml"));
                ...
                Stage loanStatusWindow = (Stage) ((Node) e.getSource()).getScene().getWindow();
                loanStatusWindow.setScene(loanStatusUI);
                //lsController.setActiveUser(activeUser);
                lsController.setPreviousScene(((Node) e.getSource()).getScene());
